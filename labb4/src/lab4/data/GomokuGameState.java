...
public class GomokuGameState extends Observable implements Observer {
  ...
  /**
   * If the other player leaves this method clears the game grid and notifies the players.
   * 
   */
  ...
  /**Called when the disconnectbutton is pressed
  ...
  /**
   * The player receives a move from the other player and checks if the other player has won by this move
   * if so the game is declared finished 
